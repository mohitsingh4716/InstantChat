...
export const create= mutation({
    ...
    handler:async(ctx, args)=>{
        ...
        if(!identity){
            throw new ConvexError("You must be logged in to create a request/Unauthorized");
        }
...
export const deny = mutation({
    ...
    handler:async(ctx, args)=>{
        ...
        if(!request || request.receiver !== currentUser._id){
            throw new ConvexError("There is error denying this request");
        }
...
export const accept = mutation({
    args: {
        ...
        if(!request || request.receiver !== currentUser._id){
            throw new ConvexError("There is error accepting this request");
        }
